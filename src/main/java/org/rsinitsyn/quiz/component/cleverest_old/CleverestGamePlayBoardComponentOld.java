...
@Slf4j
@Deprecated
public class CleverestGamePlayBoardComponentOld extends VerticalLayout {
...
//            userDiv.add(userProfile(userState.snapshot()));
    ...
    private void renderQuestion(QuestionModel question, int questionNumber, int totalQuestions, int roundNumber) {
        ...
        renderTopContainerForHost(broadcaster.getState(gameId).getAllUserStates());
...
//        });
    ...
    private void showCorrectAnswer(QuestionModel question,
        ...
        users.forEach(userGameState -> {
            ...
            row.add(userProfileWithAnswer(userGameState,
                    question.getType(),
